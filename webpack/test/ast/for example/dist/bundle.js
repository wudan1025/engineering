 ...
 * @description: 文件描述
 */
console.log("src/title.js 5:0", 111);
...
console.log("src/index.js 10:0", 111); //  不引入 lodash 3.65 k
//  代码全部引入 lodash 536 K
...
load.addEventListener('click', () => {
  Promise.resolve(/*! import() */).then(__webpack_require__.t.bind(__webpack_require__, /*! ./title */ "./src/title.js", 23)).then(result => {
    console.log("src/index.js 20:4", result.default);
  });
});
})();
